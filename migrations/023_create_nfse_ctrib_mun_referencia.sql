...
CREATE TABLE IF NOT EXISTS nfse_ctrib_mun_referencia (
    ...
    UNIQUE KEY uq_nfse_ctrib_mun_codigo (codigo_ibge, codigo_tributacao_municipal),
    INDEX idx_nfse_ctrib_mun_municipio (codigo_ibge),
    INDEX idx_nfse_ctrib_mun_codigo (codigo_tributacao_municipal)
