...
ENDPOINT_PERMISSION_MAP = {
    ...
    'contratos.index': 'contratos_view',
    'contratos.visualizar': 'contratos_view',
    'contratos.editar': 'contratos_edit',
    'contratos.assinar': 'contratos_sign',
    'contratos.cancelar': 'contratos_delete',
    'contratos.historico': 'contratos_view',
    'contratos.clausulas_lista': 'clausulas_view',
    'contratos.clausulas_criar': 'clausulas_create',
    'contratos.clausulas_editar': 'clausulas_edit',
    'contratos.gerar_orcamento': 'contratos_create',
}
...
def create_app(config_name=None):
    ...
    def inject_user():
        ...
        from src.utils import get_empresa_logo
        ...
        return {
            ...
            'get_empresa_logo': get_empresa_logo,
            ...
            'has_activity': lambda activity: getattr(getattr(current_user, 'empresa', None), f'atividade_{activity}', False),
        }
    ...
    # Create database tables and required directories
    with app.app_context():
        # Create required directories for NFS-e Nacional
