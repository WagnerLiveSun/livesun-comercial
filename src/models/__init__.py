...
from src.models import locacao
...
class Entidade(db.Model):
    ...
    codigo_municipio_ibge = db.Column(db.String(7), nullable=True, index=True)
...
class NfseMunicipioReferencia(db.Model):
    ...
    __tablename__ = 'nfse_municipios_referencia'

    __table_args__ = (

        db.UniqueConstraint('codigo_ibge', name='uq_nfse_municipio_codigo_ibge'),
    ...
    codigo_ibge = db.Column(db.String(7), nullable=False, index=True)

    nome_uf = db.Column(db.String(120), nullable=False)

    uf_sigla = db.Column(db.String(2), nullable=False, index=True)

    nome_municipio = db.Column(db.String(120), nullable=False, index=True)

    pais_iso2 = db.Column(db.String(2), nullable=True, index=True)
...
class NfseCnaeReferencia(db.Model):
    ...
    __tablename__ = 'nfse_cnae_referencia'

    __table_args__ = (

        db.UniqueConstraint('codigo', name='uq_nfse_cnae_codigo'),

        db.Index('idx_nfse_cnae_codigo', 'codigo'),

        db.Index('idx_nfse_cnae_denominacao', 'denominacao'),
    ...
    denominacao = db.Column(db.String(500), nullable=False)

    secao = db.Column(db.String(2), nullable=True)

    divisao = db.Column(db.String(5), nullable=True)

    grupo = db.Column(db.String(10), nullable=True)

    classe = db.Column(db.String(10), nullable=True)

    subclasse = db.Column(db.String(20), nullable=True)
...
class NfseServicoNacionalReferencia(db.Model):
    ...
    __table_args__ = (
        ...
        db.UniqueConstraint('codigo_tributacao_nacional', 'item', 'subitem', 'desdobro_nacional', name='uq_nfse_servico_catalogo'),
    ...
    codigo_tributacao_nacional = db.Column(db.String(20), nullable=True, index=True)

    item = db.Column(db.String(10), nullable=True)

    subitem = db.Column(db.String(10), nullable=True)

    desdobro_nacional = db.Column(db.String(10), nullable=True)
...
class NfseNbsReferencia(db.Model):
    ...
    __table_args__ = (
        ...
        db.UniqueConstraint('codigo_nbs', name='uq_nfse_nbs_codigo'),
    ...
    codigo_nbs = db.Column(db.String(20), nullable=False, index=True)

    descricao = db.Column(db.Text, nullable=False)

    origem_catalogo = db.Column(db.String(40), nullable=True)
...
class NfseIndOpReferencia(db.Model):
    ...
    __table_args__ = (
        ...
        db.UniqueConstraint('codigo_indop', name='uq_nfse_indop_codigo'),
    ...
    codigo_indop = db.Column(db.String(20), nullable=False, index=True)

    art = db.Column(db.String(20), nullable=True)

    tipo_operacao = db.Column(db.Text, nullable=False)

    considera_local_operacao = db.Column(db.Text, nullable=True)

    caracteristica_fornecimento = db.Column(db.Text, nullable=True)

    local_fornecimento_identificado = db.Column(db.Text, nullable=True)

    campo_leiaute = db.Column(db.Text, nullable=True)
...
class NfseCtribMunReferencia(db.Model):
    ...
    __table_args__ = (
        ...
        db.UniqueConstraint('codigo_ibge', 'codigo_tributacao_municipal', name='uq_nfse_ctrib_mun_codigo'),

        db.Index('idx_nfse_ctrib_mun_municipio', 'codigo_ibge'),
    ...
    uf_sigla = db.Column(db.String(2), nullable=False)

    nome_municipio = db.Column(db.String(120), nullable=False)

    codigo_tributacao_municipal = db.Column(db.String(12), nullable=False, index=True)

    descricao = db.Column(db.Text, nullable=False)

    exige_ctribmun = db.Column(db.Boolean, default=True)
...
class Empresa(db.Model):
    ...
    atividade_comercial = db.Column(db.Boolean, default=True)

    atividade_servicos = db.Column(db.Boolean, default=True)

    atividade_financeiro = db.Column(db.Boolean, default=True)

    atividade_locacao = db.Column(db.Boolean, default=False)
...
class NfseNacionalCertificado(db.Model):
    ...
    removed_by = db.Column(db.String(120), nullable=True)
...
class Orcamento(db.Model):
    ...
    validade_precos = db.Column(db.Text)

    condicoes_pagamento = db.Column(db.Text)

    termos_compra = db.Column(db.Text)
