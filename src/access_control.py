...
PERMISSION_CATALOG: List[Dict[str, str]] = [
    ...
    {"key": "comercial_filiais", "label": "Filiais", "group": "Comercial"},
    {"key": "comercial_produtos", "label": "Produtos", "group": "Comercial"},
    {"key": "comercial_servicos", "label": "Servicos", "group": "Comercial"},
    {"key": "comercial_estoque", "label": "Estoque", "group": "Comercial"},
    {"key": "comercial_compras", "label": "Compras (NF Manual)", "group": "Comercial"},
    {"key": "comercial_documentos", "label": "Documentos nao fiscais", "group": "Comercial"},
    {"key": "comercial_tabelas_preco", "label": "Tabelas de Preco", "group": "Comercial"},
    {"key": "comercial_orcamentos", "label": "Orcamentos", "group": "Comercial"},
    {"key": "comercial_pedidos", "label": "Pedidos", "group": "Comercial"},
    {"key": "comercial_pdv", "label": "PDV / Caixa", "group": "Comercial"},
    ...
    {"key": "usuarios", "label": "Gerenciar Usuários", "group": "Administração"},
    {"key": "controle_acesso", "label": "Controle de Acesso", "group": "Administração"},
    {"key": "locacao_acervo", "label": "Acervo de Locação", "group": "Locação"},
    {"key": "locacao_agenda", "label": "Agenda de Locação", "group": "Locação"},
    {"key": "locacao_contratos", "label": "Contratos de Locação", "group": "Locação"},
    {"key": "locacao_operacao", "label": "Operação de Locação", "group": "Locação"},
    {"key": "contratos_view", "label": "Visualizar Contratos", "group": "Contratos"},
    {"key": "contratos_create", "label": "Criar Contratos", "group": "Contratos"},
    {"key": "contratos_edit", "label": "Editar Contratos", "group": "Contratos"},
    {"key": "contratos_delete", "label": "Excluir Contratos", "group": "Contratos"},
    {"key": "contratos_sign", "label": "Assinar Contratos", "group": "Contratos"},
    {"key": "contratos_export", "label": "Exportar Contratos", "group": "Contratos"},
    {"key": "clausulas_view", "label": "Visualizar Cláusulas", "group": "Contratos"},
    {"key": "clausulas_create", "label": "Criar Cláusulas", "group": "Contratos"},
    {"key": "clausulas_edit", "label": "Editar Cláusulas", "group": "Contratos"},
    {"key": "clausulas_delete", "label": "Excluir Cláusulas", "group": "Contratos"},
]
...
def require_permission(permission_key: str):
    """Decorator que bloqueia rotas quando o usuário não tem a permissão informada."""
