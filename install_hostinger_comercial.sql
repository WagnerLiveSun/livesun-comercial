-- LiveSun Comercial - Instalacao completa para Hostinger (MySQL 5.7+ / 8+)
--
-- COMO USAR NO HOSTINGER:
-- 1) No hPanel, crie o banco MySQL (ex.: u123456789_comercial)
-- 2) Crie o usuario MySQL e conceda privilegios para esse banco
-- 3) Abra o phpMyAdmin e selecione o banco criado
-- 4) No SQL, execute primeiro o comando USE abaixo, trocando pelo nome real do seu banco
-- 5) Cole/executa este script completo
--
-- IMPORTANTE:
-- - Em hospedagem compartilhada geralmente NAO ha permissao para CREATE DATABASE.
-- - Este script cria todas as tabelas do sistema + seed do plano de contas padrao.

-- Banco informado pelo usuario:
-- u951548013_LS_Comercial
...
-- Seed do plano de contas padrao.
-- Garante empresa inicial para evitar erro de chave estrangeira em banco novo.
INSERT INTO empresas (nome, cnpj, plano)
SELECT 'Empresa Inicial', '00.000.000/0000-00', 'premium'
FROM DUAL
